...
class Application(object):
    screen_manager: services.ScreenManagerService = field(
        default_factory=services.ScreenManagerService
    )
    display_configurator: services.DisplayConfigurationService = field(
        default_factory=services.DisplayConfigurationService
    )
